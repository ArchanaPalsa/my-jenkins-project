...
public class UserRestrictionsPageEER extends BaseEngine
{
...
*/
	...
	@FindBy(xpath="//*[@id='chkExclusion']")
	private static WebElement exclusionCheckBox; 
	...
	public static boolean checkValidateRestrictionsGivenInRERRoleInSu() throws InterruptedException
	{
		...
		createRoleRoleNameCombo.sendKeys("EER");
		Thread.sleep(2000);
		...
		boolean actDeptExclusion = exclusionCheckBox.isSelected();
		boolean expDeptExclusion = true;
		...
		boolean actWareExclusion = exclusionCheckBox.isSelected();
		boolean expWareExclusion = true;
		...
		boolean actBranchExclusion = exclusionCheckBox.isSelected();
		boolean expBranchExclusion = true;
		...
		String expAccountsList = "[A, D, F, E, H, SalesACC, CustomerACC, VendorACC, PurchaseACC, CashACC, BankACC]";
		...
		System.out.println("actAccExclusion: "+actAccExclusion);
		System.out.println("expAccExclusion: "+expAccExclusion);

		System.out.println("actItemExclusion: "+actItemExclusion);
		System.out.println("expItemExclusion: "+expItemExclusion);

		System.out.println("actDeptExclusion: "+actDeptExclusion);
		System.out.println("expDeptExclusion: "+expDeptExclusion);

		System.out.println("actWareExclusion: "+actWareExclusion);
		System.out.println("expWareExclusion: "+expWareExclusion);

		System.out.println("actBranchExclusion: "+actBranchExclusion);
		System.out.println("expBranchExclusion: "+expBranchExclusion);
		...
		if (actAccExclusion == expAccExclusion && actItemExclusion == expItemExclusion && actDeptExclusion == expDeptExclusion
				&& actWareExclusion == expWareExclusion && actBranchExclusion == expBranchExclusion && actAccountsList.equalsIgnoreCase(expAccountsList) && actItemList.equalsIgnoreCase(expItemList)
	...
	public static boolean checkChildAccountsInsideTheGroupAccountsIndivdually() throws InterruptedException
	{
		...
		ArrayList<String> childAccountsInG = new ArrayList<String>();

		for (int i = 0; i < count3; i++) 
		{
			String data = masterGridBodyName.get(i).getText();
			childAccountsInG.add(data);
		}
		Thread.sleep(2000);

		String actchildAccountsInG = childAccountsInG.toString();
		String expchildAccountsInG = "[G1, G2]";

		System.out.println("actchildAccountsInG:"+actchildAccountsInG);
		System.out.println("expchildAccountsInG:"+expchildAccountsInG);
		Thread.sleep(2000);
		...
		ArrayList<String> childAccountsInC = new ArrayList<String>();

		for (int i = 0; i < count4; i++) 
		{
			String data = masterGridBodyName.get(i).getText();
			childAccountsInC.add(data);
		}

		String actchildAccountsInC = childAccountsInC.toString();
		String expchildAccountsInC = "[C1, C2]";

		System.out.println("actchildAccountsInB:"+actchildAccountsInC);
		System.out.println("expchildAccountsInB:"+expchildAccountsInC);

		


		if (actchildAccountsInG.equalsIgnoreCase(expchildAccountsInG)&& 
				actchildAccountsInC.equalsIgnoreCase(expchildAccountsInC) )
		{
			return true;
		} 
		else 
	...
	public static boolean checkSearchAccountsWhetherNonRestrictedAccountsAreDisplaying() throws InterruptedException
	{
		...
		String expvendorAccount = "[Vendor A]";
	...
	public static boolean checkSearchDepartmentWhetherNonRestrictedDepartmentsAreDisplaying() throws InterruptedException
	{
		...
		String actdeptList = deptList.toString();
		String expdeptList = "[C, C1, C2, FIN]";

		System.out.println("actdeptList:  "+actdeptList);
		System.out.println("expdeptList:  "+expdeptList);

		searchAccount.sendKeys(Keys.END,Keys.SHIFT,Keys.HOME);
		searchAccount.sendKeys("INV");
		Thread.sleep(1500);
		searchAccount.sendKeys(Keys.ENTER);
	...
	public static boolean checkWarehouseMasterWhetherShowingOnlyRestrictedWarehouseInList() throws InterruptedException
	{
		...
		String expWarehouseNamesinTree = "[C]";
		...
		String expWarehouseListInA = "[C, SEC]";
		...
		String exWarehouseListInB  = "[C, SEC]";
	...
	public static boolean checkSearchWarehouseWhetherNonRestrictedWarehousesAreDisplaying() throws InterruptedException
	{
		...
		String actWarehouseList = WarehouseList.toString();
		String expWarehouseList = "[C, C1, C2, SEC]";

		System.out.println("actWarehouseList:  "+actWarehouseList);
		System.out.println("expWarehouseList:  "+expWarehouseList);

		searchAccount.sendKeys(Keys.END,Keys.SHIFT,Keys.HOME);
		searchAccount.sendKeys("HYD");
		Thread.sleep(1500);
		searchAccount.sendKeys(Keys.ENTER);
	...
	public static boolean checkPurchaseVoucherHomePageMastersList() throws InterruptedException
	{
		...
		String actItemList = ItemList.toString();
		String expItemList = "[Doll, CAM, C1, BALL, C2, CAM, Doll, C2, BALL, C1, C2, CAM, BALL, Doll, C1, ]";
		...
		String actWarehouseList = WarehouseList.toString();
		String expWarehouseList = "[SEC, SEC, SEC, SEC, SEC, C2, C2, C2, C2, C2, C1, C1, C1, C1, C1, ]";
		...
		String expDepartmentList = "[FIN, FIN, FIN, FIN, FIN, C2, C2, C2, C2, C2, C1, C1, C1, C1, C1, ]";
		...
		String actBranchList = BranchList.toString();
		String expBranchList = "[BR-SEC, BR-SEC, BR-SEC, BR-SEC, BR-SEC, BR-SEC, BR-SEC, BR-SEC, BR-SEC, BR-SEC, BR-SEC, BR-SEC, BR-SEC, BR-SEC, BR-SEC, ]";
		...
		String expPurchaseAccList = "[Cost of goods sold - Computers, Cost of goods sold - Computers, Cost of goods sold - Computers, Cost of goods sold - Computers, Cost of goods sold - Computers, Inventory Trade, Inventory Trade, Inventory Trade, Inventory Trade, Inventory Trade, Purchase, Purchase, Purchase, Purchase, Purchase, ]";
		...
		String expVendorAccList = "[CustVend, CustVend, CustVend, CustVend, CustVend, C2, C2, C2, C2, C2, Vendor A, Vendor A, Vendor A, Vendor A, Vendor A, ]";
	...
	public static boolean checkPurchasesVoucherForAllTheMastersListInMastersDropdown() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String expPurchaseList = "[Cost of goods sold - Computers, Cost of goods sold - Electronics, Cost of goods sold - HA, Inventory Trade, Inventory FG, Inventory RM, Purchase]";
		...
		String expvendorList = "[Bank, C1, C2, Cash, ClosingACC, CustVend, rakesh, rathod, Vendor A, Vendor B]";
		...
		String expwarehouseList = "[C1, C2, SEC]";
		...
		String expdepartmentList = "[C1, C2, FIN]";
	...
	public static boolean checkMastersListInSalesInvoices() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String expSalesList = "[Legal Fee, Sales - Computers, Sales - Electronics, Sales - Home Appliances, Uninvoiced DO, Utility charges]";
		...
		String expCustomerList = "[Bank, Cash, Customer A, Customer B, Customer C, CustVend, G1, G2]";
	...
	public static boolean checkPaymentsVoucherHomePageMastersList() throws InterruptedException
	{
		...
		String actDepartmentList = DepartmentList.toString();
		String expDepartmentList = "[C1, C1, ]";
		...
		String expCBAccountList = "[Cash, Cash, ]";
	...
	public static boolean checkMastersListInPayments() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
	{
		...
		String expAccountList = "[Authorized Capital, Bank, Bank Charges, Basic Salary, C1, C2, Cash, ClosingACC, Cost of goods sold - Computers, Cost of goods sold - Electronics, Cost of goods sold - HA, Courier Charges, Custom Duty Payable, Customer A, Customer B, Customer C, CustVend, Depreciation, Dividend Payable, Employee Payable, Exchange Gain, Exchange Loss, Financial Charges, Fixed Deposit Investment, Freight Payable, G1, G2, Gain on Asset Sale, Housing Allowance, Interest paid, Inventory Trade, Inventory FG, Inventory RM, Journal Entries Control A/C, Land and Building, Legal Fee, Loan from associate company, Loan from Director, Long-term Debt, Loss on Asset Sale, Office Equipment, Office Rent, Opening Balances Control A/C, Paid-up Capital, Printing and Stationery, Profit/Loss A/C, Provion for Employee Benefits, Provision for Bad Debts, Purchase]";
	...
	public static boolean checkReceiptsHomePageMasterList() throws InterruptedException
	{
		...
		String actDepartmentList = DepartmentList.toString();
		String expDepartmentList = "[C2, C2, ]";
		...
		String actCBAccountList = CBAccountList.toString();
		String expCBAccountList = "[Bank, Bank, ]";
	...
	private static WebElement transactionCloseBtn;
	...
	public UserRestrictionsPageEER(WebDriver driver)
	{
