...
*/
	...
	public static void checkPurchasesVoucherHeader(String date,String purAcc,String VenAcc, String Warehouse, String dept) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		Thread.sleep(1500);
		//getDriver().navigate().refresh();
	...
	public static void checkSalesInvoiceVATHeader(String date, String CustAcc,String dept, String placeOfSupply, String jurisdiction) throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
	{
	...
	public static void checkSaveSalesInvoiceVAT(int i, int j,String warehouse,String item,int u, int q,String quantity,int rt,String rate,int vat) throws InterruptedException
	{
	...
	public static void checkSTDItemforPurchasesVoucher(int i, int j,String warehouse,String item,int q,String quantity,String rate) throws InterruptedException
	{
		Thread.sleep(4000);
		checkEnterRow(i,j);
		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(enter_WarehouseTxt));
	...
	public static void checkSaveSalesInvoicesVATForSTDItem(int i, int j,String warehouse,String item,int u, int q,String quantity,int rt,String rate,int vat) throws InterruptedException
	{
	...
	public static void checkSaveRMAItemForSalesInvoiceVAT(int i, int j,String warehouse,String item,int u, int q,String quantity,int rt,String rate,int vat) throws InterruptedException
	{
		checkEnterRow(i,j);
		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(enter_WarehouseTxt));
		enter_WarehouseTxt.sendKeys(Keys.END,Keys.SHIFT,Keys.HOME);
	...
	public static void checkSaveSalesInvoicesVATForBatchItem(int i, int j,String warehouse,String item,int u, int q,String quantity,String rate,int vat) throws InterruptedException
	{
		checkEnterRow(i,j);
		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(enter_WarehouseTxt));
		enter_WarehouseTxt.sendKeys(Keys.END,Keys.SHIFT,Keys.HOME);
	...
	public static void checkBatchItemForPurchasesVoucher(int i, int j,String warehouse,String item,int q,String quantity,String rate,int b,String batch) throws InterruptedException
	{
		Thread.sleep(1000);
	...
	public static boolean checkPurchasesVoucherVATForCustomerDislayDrOrCrTotalsForEachMonth() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
	{
		...
		checkPurchasesVoucherHeader("20/01/2023","Purchase","cust_display_dr/cr_total_for_each_month","HYDERABAD","DUBAI");
	...
	public static boolean checkRaiseSalesInvoivesVATForCustomerDislayDrOrCrTotalsForEachMonth() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
	{
		...
		checkSalesInvoiceVATHeader("28/01/2023", "cust_display_dr/cr_total_for_each_month","India", "Abu Dhabi", "DUBAI");
		Thread.sleep(1500);
		...
		if(actlist.equalsIgnoreCase(expList) && actSlist.equalsIgnoreCase(expSList) && actBatchlist.equalsIgnoreCase(expBatchList) && 
				actTotalQty.equalsIgnoreCase(expTotalQty) && actQtyAdjusted.equalsIgnoreCase(expQtyAdjusted) && 
	...
	{	
		...
		checkSalesInvoiceVATHeader("28/02/2023", "cust_display_dr/cr_total_for_each_month","India", "Abu Dhabi", "DUBAI");
		Thread.sleep(1500);
	...
	{
		checkPurchasesVoucherHeader("21/01/2023","Purchase","cust_display_dr/cr_total_for_each_day","HYDERABAD","DUBAI");
	...
	public static boolean checkRaiseSalesInvoivesVATForCustomerDislayDrOrCrTotalsForEachDay() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
	{
		...
		checkSalesInvoiceVATHeader("28/03/2023", "cust_display_dr/cr_total_for_each_day","India", "Abu Dhabi", "DUBAI");
		...
		String actBatchlist = BatchList.toString();
		String expBatchList = "[1, BATCH12, 114.00, "+getCurrentDateF2()+", 8.33, 0, 20/01/2023, 2, BATCHBR, 120.00, "+getCurrentDateF2()+", 8.33, 0, 21/01/2023]";
	...
	{
		checkSalesInvoiceVATHeader("30/03/2023", "cust_display_dr/cr_total_for_each_day","India", "Abu Dhabi", "DUBAI");
		Thread.sleep(1500);
		...
		String actBatchlist = BatchList.toString();
		String expBatchList = "[1, BATCH12, 111.00, "+getCurrentDateF2()+", 8.33, 0, 20/01/2023, 2, BATCHBR, 120.00, "+getCurrentDateF2()+", 8.33, 0, 21/01/2023]";
	...
	public static boolean checkPurchasesVoucherVATForCustomerAccountAsDisplayUnRealizeGainLossInLedger() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
	{
		...
		checkPurchasesVoucherHeader(getCurrentDateF2(),"Purchase","Display_Un-Realize_GainOrLoss_In_Ledger","HYDERABAD","DUBAI");
	...
	{
		checkSalesInvoiceVATHeader(getCurrentDateF2(), "Display_Un-Realize_GainOrLoss_In_Ledger","India", "Abu Dhabi", "DUBAI");
		...
		String actBatchlist = BatchList.toString();
		String expBatchList = "[1, BATCH12, 108.00, "+getCurrentDateF2()+", 8.33, 0, 20/01/2023, 2, BATCHBR, 120.00, "+getCurrentDateF2()+", 8.33, 0, 21/01/2023, 3, BATCH3, 60.00, "+getCurrentDateF2()+", 0.21, 0, "+getCurrentDateF2()+"]";
		...
		if(actBatchlist.equalsIgnoreCase(expBatchList) && 
				actTotalQty.equalsIgnoreCase(expTotalQty) && actQtyAdjusted.equalsIgnoreCase(expQtyAdjusted) && 
				/*actbatchPicked.equalsIgnoreCase(expbatchPicked) */actMessage.startsWith(expMessage))
		{
			return true;
	...
	public boolean checkLedgerReportForCustomerAccountAsDisplayUnRealizeGainLossInLedger() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, ParseException
	{
		...
		String expRow2List = "["+currentdate+", PurVou : 3, Purchase, , 650.00, 650.00, , 650.00, 650.00, , 32.50, 32.50, United Arab Emirates Dirham]";
		...
		String expRow3List = "["+currentdate+", NDT55 : 5, Sales - Computers, 42.00, , 608.00, 42.00, , 608.00, 2.10, , 30.40, United Arab Emirates Dirham]";
		...
		String expRow4List = "["+currentdate+", NDT55 : 5, Sales - Computers, 63.00, , 545.00, 63.00, , 545.00, 3.15, , 27.25, United Arab Emirates Dirham]";
		...
		String expRow5List = "["+currentdate+", Rct : 1, Bank, , 200.00, 745.00, , 200.00, 745.00, , 12.00, 39.25, United Arab Emirates Dirham]";
	...
	{
		Thread.sleep(3000);
		checkSalesInvoiceVATHeader(getCurrentDateF2(), "cust_Display_when_StatusIsActive","India", "Abu Dhabi", "DUBAI");
	...
	public static boolean checkCustomerStatementsReportForCustDisplayWhenStatusIsActive() throws InterruptedException
	{
		...
		String actRow2List = reportsByWarehouseRow2ListArray.toString();
		String expRow2List = "[cust_display_when_StatusIsActive, 210.00, , , 210.00, 210.00, 210.00, , , 210.00, Delay in Payment, Indian Rupees, "+currentDate+", CustActive, INDIA, INDIA, 14.70, , , 14.70]";
	...
	public static boolean checkChangeAccountPropertyFromActiveToInActive() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		Thread.sleep(2500);
...
*/
	...
	public static boolean checkSalesInvoiceVatForInactiveAccount() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		Thread.sleep(1500);
	...
	{
		checkSalesInvoiceVATHeader(getCurrentDateF2(), "DoNot_Restrict_If_Rights_Are_Not_Allotted","India", "Abu Dhabi", "DUBAI");
	...
	public static boolean checkRaiseSalesInvoivesVATForCustomerDisplayLedgerByCurrency() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
	{
		...
		checkSalesInvoiceVATHeader(getCurrentDateF2(), "cust_display_ledger_by_Currency","India", "Abu Dhabi", "DUBAI");
	...
	public static boolean checkCustomerStatementsReportForCreatedCustomerAccountDisplayLedgerByCurrency() throws InterruptedException
	{
		...
		String actRow2List = reportsByWarehouseRow2ListArray.toString();
		String expRow2List = "[NDT55:8, "+getCurrentDateF2()+", cust_display_ledger_by_currency, 210.00, , , 210.00, 210.00, 210.00, , , 210.00, Delay in Payment, Indian Rupees, "+getCurrentDateF2()+", CustLedger, INDIA, INDIA, 14.70, , , 14.70, ]";
	...
	public static boolean checkRaiseSalesInvoivesVATForCustomerAccountOneInGroup() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
	{
		...
		checkSalesInvoiceVATHeader(getCurrentDateF2(), "cust-club trans of all accts One","India", "Abu Dhabi", "DUBAI");
	...
	public static boolean checkRaiseSalesInvoivesVATForCustomerAccountTwoInGroup() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
	{
		...
		checkSalesInvoiceVATHeader(getCurrentDateF2(), "cust-club trans of all accts two","India", "Abu Dhabi", "DUBAI");
	...
	public static boolean checkCustomerStatementsReportDetailsForGroupAccountCustCulbTransactionsOfAllAccountsUnderGroup() throws InterruptedException
	{
		...
		String actRow3List = reportsByWarehouseRow3ListArray.toString();
		String expRow3List = "[PurVou:4, "+currentDate+", cust-club trans of all accts One, 400.00, , , 400.00, 190.00, 400.00, , , 400.00, Delay in Payment, Indian Rupees, "+currentDate+", custOne, DUBAI, DUBAI]";
		...
		String actRow4List = reportsByWarehouseRow4ListArray.toString();
		String expRow4List = "[NDT55:9, "+currentDate+", cust-club trans of all accts One, 210.00, , , 210.00, 20.00, 210.00, , , 210.00, Delay in Payment, Indian Rupees, "+currentDate+", custOne, DUBAI, DUBAI]";
	...
	public static boolean checkRaiseSalesInvoivesVATForCustomerAccountOneInGroupForDrOrCrTotlas() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
	{
		...
		checkSalesInvoiceVATHeader(getCurrentDateF2(), "Cust-display cr dr total each account one","India", "Abu Dhabi", "DUBAI");
	...
	public static boolean checkRaiseSalesInvoivesVATForCustomerAccountTwoInGroupForDrOrCrTotlas() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
	{
		...
		checkSalesInvoiceVATHeader(getCurrentDateF2(), "Cust-display cr dr total each account two","India", "Abu Dhabi", "DUBAI");
	...
	public static boolean checkEnableShowSummaryOfTheAccountforAnAccount() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		Thread.sleep(2000);
	...
	public static boolean checksetSavedConfigureMastersIntoSalesInvoicesBody() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
	...
	public static boolean checkSaveSalesInvoiceVoucherWithSavedBodyMasters() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
...
*/
	...
	public static boolean checkCopyToClipboardAndPasteFromClipboard() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
	{
		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(documentNumberTxt));
