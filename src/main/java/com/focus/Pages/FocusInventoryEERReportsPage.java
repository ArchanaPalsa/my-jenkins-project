...
public class FocusInventoryEERReportsPage extends BaseEngine {
	...
	public boolean checkItemQueryReport() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String expiq_CurrentStock				="12.00";
		String expiq_PendingSalesOrders			="0.00";
		String expiq_AvgStockRate				="10.19";
		String expiq_QtyToBeOrdered				="0.00";
		String expiq_Value						="122.29";
		...
		String exppurchasesListR1 = "[27-07-2022, PurVou:11, C2, 1.00, , 1.00, Indian Rupees, 1.0000000000]";
		...
		String exppurchasesListR2 = "[27-07-2022, PurVou:12, CustVend, 1.00, , 1.00, Indian Rupees, 1.0000000000]";
		...
		String exppurchasesListR3 = "[21-07-2022, PurVou:7, Vendor A, 10.00, , 10.00, Indian Rupees, 10.0000000000]";
		...
		String exppurchasesListR4 = "[Quantity Purchased Till Date:, 13.00, , ]";
		...
		String expsalesListR1 = "[27-07-2022, SalInv:7, G2, 2.00, , 1.00, Indian Rupees, 2.0000000000]";
		...
		String expsalesListR2 = "[Quantity Sold Till Date:, 2.00, , ]";
		...
		String expWarehouseListR1 = "[1, SEC, 2.00, 0.00, 2.00, 5.50, 11.00]";
		...
		String expWarehouseListR2 = "[2, C1, 7.00, 0.00, 7.00, 10.00, 70.00]";
		...
		String expWarehouseListR3 = "[3, C2, 3.00, 0.00, 3.00, 11.50, 34.50]";
		...
		String expWarehouseListR4 = "[, , 12.00, 0.00, 12.00, , 115.50]";
		...
		if (actiq_OpeningStocks.equalsIgnoreCase(expiq_OpeningStocks) && actiq_PendingPurchaseOrders.equalsIgnoreCase(expiq_PendingPurchaseOrders)
			...
			&&actpurchasesListR4.equalsIgnoreCase(exppurchasesListR4)
			
			
			&&actsalesListR1.equalsIgnoreCase(expsalesListR1)&&actsalesListR2.equalsIgnoreCase(expsalesListR2)
			...
			&&actBinsListR1.equalsIgnoreCase(expBinsListR1))
		{
	...
	public static boolean checkStockLedgerReport() throws InterruptedException
	{
		...
		String expRow1List = "[Grand Total, , , , , , , , 82.00, 239.50, 29.00, 198.00, 53.00, 777.50, 298.00, 519.84, 454.08, , , ]";
	...
	public static boolean checkFilterInStockLedger() throws InterruptedException
	{
		...
		osr_DefaultFilterTxt.sendKeys("SEC");
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[Grand Total, , , , , , , , 9.00, 45.00, , , 9.00, 45.00, , 45.00, 27.00, , , ]";
	...
	public static boolean checkOpeningStockRegisterReport() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[C2, 1.00, 1.00, 1.00, 6262, C2]";
		...
		String expRow2List = "[C1, 1.00, 1.00, 1.00, 26262, C2]";
		...
		String expRow3List = "[BALL, 1.00, 1.00, 1.00, 111, C2]";
		...
		String expRow4List = "[CAM, 1.00, 1.00, 1.00, 666, C2]";
		...
		String expRow5List = "[Grand Total, 4.00, 4.00, 4.00]";
	...
	public static boolean checkStockStatementReport() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[Grand Total, 58.00, 78.00, 29.00, 53.00, 519.84, , , , ]";
	...
	public static boolean checkPrintOptionInStockStatements() throws IOException, InterruptedException, AWTException
	{
		...
		File Efile=new File(getBaseDir()+"\\autoIt\\ExportFiles\\EERstockStatements.pdf");
...
// Robot replaced by RobotUtility (works in Jenkins headless mode)
		...
		Runtime.getRuntime().exec(getBaseDir() + "\\autoIt\\scripts\\EERStockStatementsPrintSaving.exe");
		...
		Thread.sleep(1000);
	 	...
	 	String actPDF = getBaseDir()+"\\autoIt\\ExportFiles\\EERstockStatements.pdf";
		String expPDF = getBaseDir()+"\\autoIt\\ImportFiles\\EERstockStatements.pdf";
	...
	public static boolean checkStockMovementReport() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[BALL, Doll, CAM, C1, C2, Grand Total]";
		...
		String expRowList = "[Grand Total, 4.00, 4.00, 78.00, 777.50, 29.00, 261.66, 53.00, 519.84, 48.33, , , ]";
	...
	public static boolean checkVirtualStockAnalysisReport() throws InterruptedException
	{
		...
		String actRowList = reportsRowListArray.toString();
		String expRowList = "[Grand Total, 53.00, , , , 53.00]";
	...
	public static boolean checkStockValuationReportByProduct() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[BALL, CAM, Doll, C, C1, C2]";
		...
		String actRowList = reportsRowListArray.toString();
		String expRowList = "[Grand Total, , , 53.00, 519.84, 48.33, , ]";
	...
	public static boolean checkStockValuationReportByProductByInventoryTag() throws InterruptedException
	{
		...
		String expRow8List = "[C1, C1, C2, C2, SEC, SEC, C1, C2, SEC, C1, C1, C2, C2, SEC, SEC]";
		...
		String actRowList = reportsRowListArray.toString();
		String expRowList = "[Grand Total, , , 53.00, 486.13, 119.88, , ]";
	...
	public static boolean checkStockValuationReportByInventoryByProduct() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[C1, BALL, C1, C2, CAM, Doll, C2, BALL, C1, C2, CAM, Doll, SEC, BALL, C1, C2]";
		...
		String actRow8List = reportsRow8ListArray.toString();
		String expRow8List = "[C1, C1, C1, C1, C1, C2, C2, C2, C2, C2, SEC, SEC, SEC, SEC]";
	...
	public static boolean checkStockReprtByTagReport() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[BALL, Doll, CAM, C, C1, C2]";
		...
		String actRowList = reportsRowListArray.toString();
		String expRowList = "[Grand Total, 53.00, 37.90, 519.84, 9.00, 17.50, 45.00, 32.00, 39.00, 311.00, 12.00, 35.94, 130.13]";
	...
	public static boolean checkStockValuationByFATagReport() throws InterruptedException
	{
		...
		String actRowList = reportsRowListArray.toString();
		String expRowList = "[Grand Total, , 53.00, 128.92, 205.08]";
	...
	public static boolean checkABCAnalysisReport() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[A Product, C1, CAM, C2, BALL, Doll, Grand Total]";
		...
		String actRow2List = reportsRow2ListArray.toString();
		String expRow2List = "[12.00, 10.00, 11.00, 13.00, 7.00, 53.00]";
		...
		String actRow3List = reportsRow3ListArray.toString();
		String expRow3List = "[122.29, 105.31, 117.05, 122.25, 52.94, 519.84]";
	...
	/*	getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(stockAnalysisByBatch));
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[BAL001, BAL001, BAL001, BAL001, BAL001, CAM001, CAM001, CAM001, CAM001, CAM001, Grand Total]";
		...
		String actRow2List = reportsRow2ListArray.toString();
		String expRow2List = "[11, 22, 151, 1111, 270722PC1, 2, 151, 26262, 220722CAM, 270722CAM]";
		...
		String actRowList = reportsRowListArray.toString();
		String expRowList = "[Grand Total, , , 23.00, 94.50, 224.50, , , ]";
	...
	public static boolean checkStockAgeingAnalysisByRMAReport() throws InterruptedException
	{
		...
		String actPage2Row1List = reportsPage2Row1ListArray.toString();
		String expPage2Row1List = "[270722C1P2, 270722C1P5, 270722C1P6, 270722C1P7, 270722C1P8, 270722C1P9, dsd115]";
		...
		String actRowList = reportsRowListArray.toString();
		String expRowList = "[Grand Total, 23.00, 239.34, 23.00, 239.34]";

		System.out.println("actRow1List"+actRowList);
		System.out.println("expRow1List"+expRowList);
		

		if (actRow1List.equalsIgnoreCase(expRow1List)  && actAllDatapage1.equalsIgnoreCase(expAllDatapage1) && actPage2Row1List.equalsIgnoreCase(expPage2Row1List) 
					&& actRowList.equalsIgnoreCase(expRowList)) 
		{
			return true;
		} 
	...
	public static boolean checkStockDetailsByBins() throws InterruptedException
	{
		...
		String actRow2List = reportsRow2ListArray.toString();
		String expRow2List = "[2, BIN1, 0, 0, 7.00]";
		...
		int reportsRow3ListCount = reportsRow3List.size();
		ArrayList<String> reportsRow3ListArray = new ArrayList<String>();
		for(int i=0;i<reportsRow3ListCount-1;i++)
		{
			String data = reportsRow3List.get(i).getText().trim();
			if(data.isEmpty() == false)
			{
		...
		String actRow3List = reportsRow3ListArray.toString();
		String expRow3List = "[3, Grand Total, 7.00]";
...
Thread.sleep(2000);
		...
		String actRow2List = reportsRow2ListArray.toString();
		String expRow2List = "[2, Doll, 0, 0, 7.00]";
	...
	public static boolean checkStockBalanceByWarehouse() throws InterruptedException
	{
		...
		String actRowList = reportsRowListArray.toString();
		String expRowList = "[Grand Total, 54.00, , 54.00]";
	...
	public static boolean checkAgeingAnalysisByBatchReport() throws InterruptedException
	{
		...
		if (actRow1List.equalsIgnoreCase(expRow1List) && actAllDatapage1.equalsIgnoreCase(expAllDatapage1)) 
		{
			return true;
		} 
		else 
	...
	public static boolean checkStockAnalysisByRMAReport() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[15151, 265262, 515151, dsd115, 220722EX1, 220722EX2, 220722EXC1, 270722C1P2, 270722C1P5, 270722C1P6, 270722C1P7, 270722C1P8, 270722C1P9, 270722C2P2, 270722C2P4, 270722C2P5, 270722C2P6, 270722C2P7]";
		...
		String actRow2List = reportsRow2ListArray.toString();
		String expRow2List = "[C1, C2, C1, C2, C2, C2, C1, C2, C2, C2, C2, C2, C2, C1, C1, C1, C1, C1, C1]";
		...
		String actPage2Row1List = reportsPage2Row1ListArray.toString();
		String expPage2Row1List = "[270722C2P9, 220722EXC12, 270722C1P10, 270722C2P10]";
		...
		String expPage2Row2List = "[C1, C1, C2, C1]";

		System.out.println("ActualItems  :"+actPage2Row2List);
		System.out.println("ExpectedItems:"+expPage2Row2List);
		...
		String actRowList = reportsRowListArray.toString();
		String expRowList = "[Grand Total, 23.00, 266.50, 266.50]";

		System.out.println("actRow1List"+actRowList);
		System.out.println("expRow1List"+expRowList);
		
		if (actRow1List.equalsIgnoreCase(expRow1List) && actRow2List.equalsIgnoreCase(expRow2List) && actPage2Row1List.equalsIgnoreCase(expPage2Row1List) && actPage2Row2List.equalsIgnoreCase(expPage2Row2List) && actRowList.equalsIgnoreCase(expRowList))
		{
			return true;
		} 
		else
	...
	public static boolean checkFastMovingItemsReport() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[Doll, Doll001, Doll, 5.00, 50.00, 10.00, C1, 5.00]";
		...
		String actRow2List = reportsRow2ListArray.toString();
		String expRow2List = "[CAM, CAM001, CAM, 4.00, 50.00, 10.00, C1, 5.00]";
		...
		String actRow3List = reportsRow3ListArray.toString();
		String expRow3List = "[C2, C302, C2, 3.00, 60.00, 10.00, C1, 6.00]";
		...
		String actRow4List = reportsRow4ListArray.toString();
		String expRow4List = "[C1, C301, C1, 2.00, 70.00, 10.00, C1, 7.00]";
		...
		String actRow5List = reportsRow5ListArray.toString();
		String expRow5List = "[BALL, BAL001, BALL, 2.00, 23.00, 11.50, C2, 2.00]";
		...
		String expRow6List = "[Doll, Doll001, Doll, 1.00, 1.00, 1.00, C2, 1.00]";
		...
		String expRow7List = "[C1, C301, C1, 1.00, 34.50, 11.50, C2, 3.00]";
		...
		String actRow8List = reportsRow8ListArray.toString();
		String expRow8List = "[BALL, BAL001, BALL, 1.00, 81.00, 9.00, C1, 9.00]";
		...
		String expRow9List = "[C2, C302, C2, 1.00, 37.13, 12.38, C2, 3.00]";
		...
		String expRow10List = "[CAM, CAM001, CAM, 1.00, 34.50, 11.50, C2, 3.00]";
		...
		String expRow11List = "[Grand Total, 21.00, 441.13, 96.88, 44.00]";
	...
	public static boolean checkSlowMovingItemsReport() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[Doll, Doll001, Doll, 1.00, 1.00, 1.00, C2, 1.00]";
		...
		String actRow2List = reportsRow2ListArray.toString();
		String expRow2List = "[C1, C301, C1, 1.00, 34.50, 11.50, C2, 3.00]";
		...
		String actRow3List = reportsRow3ListArray.toString();
		String expRow3List = "[BALL, BAL001, BALL, 1.00, 81.00, 9.00, C1, 9.00]";
		...
		String actRow4List = reportsRow4ListArray.toString();
		String expRow4List = "[C2, C302, C2, 1.00, 37.13, 12.38, C2, 3.00]";
		...
		String actRow5List = reportsRow5ListArray.toString();
		String expRow5List = "[CAM, CAM001, CAM, 1.00, 34.50, 11.50, C2, 3.00]";
		...
		String actRow6List = reportsRow6ListArray.toString();
		String expRow6List = "[C1, C301, C1, 2.00, 70.00, 10.00, C1, 7.00]";
		...
		String actRow7List = reportsRow7ListArray.toString();
		String expRow7List = "[BALL, BAL001, BALL, 2.00, 23.00, 11.50, C2, 2.00]";
		...
		String actRow8List = reportsRow8ListArray.toString();
		String expRow8List = "[C2, C302, C2, 3.00, 60.00, 10.00, C1, 6.00]";
		...
		String actRow9List = reportsRow9ListArray.toString();
		String expRow9List = "[CAM, CAM001, CAM, 4.00, 50.00, 10.00, C1, 5.00]";
		...
		String actRow10List = reportsRow10ListArray.toString();
		String expRow10List = "[Doll, Doll001, Doll, 5.00, 50.00, 10.00, C1, 5.00]";
	...
	public static boolean checkPeakAndLowBlancesReport() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[BALL, 0, 31/03/2022, 1.00, 27/07/2022, 16.00]";
		...
		String actRow2List = reportsRow2ListArray.toString();
		String expRow2List = "[CAM, 0, 31/03/2022, 1.00, 27/07/2022, 14.00]";
		...
		String actRow3List = reportsRow3ListArray.toString();
		String expRow3List = "[C1, 0, 31/03/2022, 1.00, 27/07/2022, 14.00]";
		...
		String actRow4List = reportsRow4ListArray.toString();
		String expRow4List = "[C2, 0, 31/03/2022, 1.00, 27/07/2022, 14.00]";
		...
		String actRow5List = reportsRow5ListArray.toString();
		String expRow5List = "[Doll, 0, 27/07/2022, 7.00, 27/07/2022, 12.00]";
		...
		String actRow6List = reportsRow6ListArray.toString();
		String expRow6List = "[Grand Total, 11.00, 70.00]";
	...
	public static boolean checkBestSellingItemReport() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[Doll, 4.00, 5.00]";
		...
		String actRow2List = reportsRow2ListArray.toString();
		String expRow2List = "[CAM, 3.00, 4.00]";
		...
		String actRow3List = reportsRow3ListArray.toString();
		String expRow3List = "[C2, 2.00, 3.00]";
		...
		String actRow4List = reportsRow4ListArray.toString();
		String expRow4List = "[C1, 1.00, 2.00]";
		...
		String actRow5List = reportsRow5ListArray.toString();
		String expRow5List = "[Grand Total, 10.00, 14.00]";
	...
	public static boolean checkTransactionTypeWiseStockReport() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[BALL, 13.00, 122.25, 9.40, 1.00, 1.00, 12.00, 102.00, 1.00, 1.00, 1.00, 11.50, 2.00, 44.00, 1.00, 10.00, 1.00, 15.00, 1.00, 11.50, 1.00, 11.50]";
		...
		String actRow2List = reportsRow2ListArray.toString();
		String expRow2List = "[CAM, 10.00, 105.31, 10.53, 1.00, 1.00, 12.00, 102.00, 1.00, 11.50, 2.00, 44.00, 4.00, 40.00, 1.00, 15.00, 1.00, 11.50]";
		...
		String actRow3List = reportsRow3ListArray.toString();
		String expRow3List = "[C1, 12.00, 122.29, 10.19, 1.00, 1.00, 12.00, 102.00, 1.00, 11.50, 2.00, 44.00, 2.00, 20.00, 1.00, 15.00, 1.00, 11.50]";
		...
		String actRow4List = reportsRow4ListArray.toString();
		String expRow4List = "[C2, 11.00, 117.05, 10.64, 1.00, 1.00, 12.00, 102.00, 1.00, 15.00, 2.00, 44.00, 3.00, 30.00, 1.00, 1.00, 1.00, 15.00]";
		...
		String actRow5List = reportsRow5ListArray.toString();
		String expRow5List = "[Doll, 7.00, 52.94, 7.56, 12.00, 102.00, 1.00, 1.00, 5.00, 50.00, 1.00, 1.00]";
		...
		String actRow6List = reportsRow6ListArray.toString();
		String expRow6List = "[Grand Total, 53.00, 519.84, 48.33, 4.00, 4.00, 60.00, 510.00, 1.00, 1.00, 5.00, 50.50, 8.00, 176.00, 15.00, 150.00, 4.00, 46.00, 1.00, 11.50, 5.00, 50.50]";
	...
	/*	
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[BALL, 1.00, 1.00, 1.00, 1.00, 12.00, 102.00, 2.00, 44.00, 1.00, 11.50, 1.00, 10.00, 1.00, 11.50, 15.00, 9.20, 138.00]";
		...
		String actRow2List = reportsRow2ListArray.toString();
		String expRow2List = "[CAM, 1.00, 1.00, 12.00, 102.00, 2.00, 44.00, 1.00, 11.50, 4.00, 160.00, 1.00, 11.50, 11.00, 1.18, 13.00]";
		...
		String actRow3List = reportsRow3ListArray.toString();
		String expRow3List = "[C1, 1.00, 1.00, 12.00, 102.00, 2.00, 44.00, 1.00, 11.50, 2.00, 40.00, 1.00, 11.50, 13.00, 8.23, 107.00]";
		...
		String actRow4List = reportsRow4ListArray.toString();
		String expRow4List = "[C2, 1.00, 1.00, 12.00, 102.00, 2.00, 44.00, 1.00, 15.00, 3.00, 90.00, 1.00, 15.00, 12.00, 4.75, 57.00]";
		...
		String actRow5List = reportsRow5ListArray.toString();
		String expRow5List = "[Doll, 12.00, 102.00, 1.00, 1.00, 5.00, 250.00, 1.00, 1.00, 7.00, 21.14, 148.00]";
		...
		String actRow6List = reportsRow6ListArray.toString();
		String expRow6List = "[Grand Total, 4.00, 4.00, 1.00, 1.00, 60.00, 510.00, 8.00, 176.00, 5.00, 50.50, 15.00, 550.00, 5.00, 50.50, 58.00, 0.14, 141.00]";
	...
	public static boolean checkGeneralLedgerandInventoryMismatchReport() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[Opening Difference, 0, 4.00, 1.00, 3.00]";
		...
		String actRow2List = reportsRow2ListArray.toString();
		String expRow2List = "[Payments, 0, 1.00, 1.00]";
		...
		String actRow3List = reportsRow3ListArray.toString();
		String expRow3List = "[27/07/2022, 519.84, 519.84]";
		...
		String actRow4List = reportsRow4ListArray.toString();
		String expRow4List = "[Grand Total, 523.84, 2.00, 523.84]";
	...
	public FocusInventoryEERReportsPage(WebDriver driver) 
	{
