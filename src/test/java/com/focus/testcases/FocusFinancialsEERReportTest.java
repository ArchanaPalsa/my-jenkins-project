...
import com.focus.Pages.FocusFinancialsEERReportPage;
import com.focus.Pages.FocusInventoryEERReportsPage;
import com.focus.Pages.UserRestrictionsPageEER;
import com.focus.base.BaseEngine;

public class FocusFinancialsEERReportTest extends BaseEngine
{
	static FocusFinancialsEERReportPage ffrp;
	UserRestrictionsPageEER urp;
	...
	@Test(priority=98)
	public void checkLoginWithEERInFA() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		urp=new UserRestrictionsPageEER(getDriver());
	...
	@Test(priority=106)//jumbling rows
