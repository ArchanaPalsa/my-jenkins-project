...
public class AccountMasterTest extends BaseEngine 
{
	...
	@Test(priority=4007)
	public void checkLedgerIsEmptyForVendorBAfterTransfer() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, AWTException
	{	
		cmctp=new AccountMasterPage(getDriver());
	...
	//@Test(priority=4093)
	public void checkAdvancedImportOrExportAfterEnablingExportCheckBoxesInCreateTabAccountTypeAsData() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, AWTException
	{
		cmctp=new AccountMasterPage(getDriver());
...
*/
	...
	@Test(priority=9000)
	public void checksetSavedConfigureMastersIntoSalesInvoicesBody() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		cmtp=new AccountPropertiesPage(getDriver());
		Assert.assertEquals(cmtp.checksetSavedConfigureMastersIntoSalesInvoicesBody(), true);
	}

	@Test(priority=9001)
	public void checkSaveSalesInvoiceVoucherWithSavedBodyMasters() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		cmtp=new AccountPropertiesPage(getDriver());
		Assert.assertEquals(cmtp.checkSaveSalesInvoiceVoucherWithSavedBodyMasters(), true);
	}
	
	
	@Test(priority=9002)
	public void checkCopyToClipboardAndPasteFromClipboard() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		cmtp=new AccountPropertiesPage(getDriver());
		Assert.assertEquals(cmtp.checkCopyToClipboardAndPasteFromClipboard(), true);
	}
	
	@Test(priority=9003)
	public void checkValidatePastedSalesVoucher() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		cmtp=new AccountPropertiesPage(getDriver());
		Assert.assertEquals(cmtp.checkValidatePastedSalesVoucher(), true);
	}
