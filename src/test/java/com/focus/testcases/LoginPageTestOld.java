...
public class LoginPageTestOld extends BaseEngine 
{
	...
	private static LoginPageOld lp;
	  ...
	  public void checkLoginPageAvailablityOfFields() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	  {
		  ...
		  Assert.assertEquals(LoginPageOld.checkLoginPageAvailablityOfFields(), true);
	  }
	  ...
	  {
		  lp=new LoginPageOld(getDriver());
		  Assert.assertEquals(LoginPageOld.checkCompanyTextDisplayInCompanyListDropdown(), true);  
	  }
	  ...
	  {
		  lp=new LoginPageOld(getDriver());
		  Assert.assertEquals(LoginPageOld.checkSignInBtnWithValidUserNameAndValidPassword(), true);
	  }
	  ...
	  {
		  lp=new LoginPageOld(getDriver());
		  Assert.assertEquals(LoginPageOld.checkUserNameInfoInHomePage(), true);     
	  }
	  ...
	  {
		  lp=new LoginPageOld(getDriver());
		  Assert.assertEquals(LoginPageOld.checkClickOnLogoutOptionInUserNameInfo(), true);
	  }
